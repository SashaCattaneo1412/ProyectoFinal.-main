...
const connection = mysql.createConnection(process.env.DATABASE_URL='mysql://2e1qgm6s2qhgfql3l047:pscale_pw_ysKJGoQ4gXgoHOR1S3pRXgawKwDeyAq0fYNi7vgKcuH@aws.connect.psdb.cloud/proyecto?ssl={"rejectUnauthorized":true}'
);
